...
=== "Headless (локально, без MODX)"
    ...
    Для разработки без необходимости поднимать сервер и устанавливать MODX. Package Builder скачает ядро MODX и настроит окружение — этого достаточно для создания структуры пакета, сборки transport.zip и извлечения данных из кода.
...
Если у вас нет установленного MODX 3 — setup скачает ядро и настроит окружение:
